"""Fixed GSM8K chain-of-thought demonstrations used by GSM-Symbolic.

Source: EleutherAI/lm-evaluation-harness, MIT license, commit
c0745fec3062328e0ab618f36334848cdf29900e/lm_eval/tasks/gsm8k/gsm8k-cot.yaml.
"""

SHOTS = [
    {
        "question": "There are 15 trees in the grove. Grove workers will plant trees in the grove "
        "today. After they are done, there will be 21 trees. How many trees did the "
        "grove workers plant today?",
        "target": "There are 15 trees originally. Then there were 21 trees after some more were "
        "planted. So there must have been 21 - 15 = 6. The answer is 6.",
    },
    {
        "question": "If there are 3 cars in the parking lot and 2 more cars arrive, how many cars "
    ...
    },
    {
        ...
        "target": "Originally, Leah had 32 chocolates. Her sister had 42. So in total they had 32 + "
    ...
    },
    {
        ...
        "target": "Jason started with 20 lollipops. Then he had 12 after giving some to Denny. So he "
    ...
    },
    {
        ...
        "target": "Shawn started with 5 toys. If he got 2 toys each from his mom and dad, then that "
    ...
    },
    {
        ...
        "server room?",
        "target": "There were originally 9 computers. For each of 4 days, 5 more computers were "
    ...
    },
    {
        ...
        "target": "Michael started with 58 golf balls. After losing 23 on tuesday, he had 58 - 23 = "
        "35. After losing 2 more, he had 35 - 2 = 33 golf balls. The answer is 33.",
    },
    {
        "question": "Olivia has $23. She bought five bagels for $3 each. How much money does she "
        "have left?",
        "target": "Olivia had 23 dollars. 5 bagels for 3 dollars each will be 5 x 3 = 15 dollars. So "
        "she has 23 - 15 dollars left. 23 - 15 is 8. The answer is 8.",
    },
]
