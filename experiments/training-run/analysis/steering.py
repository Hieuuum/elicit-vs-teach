...
from gates import G5_N_SHOTS  # noqa: E402  (the eval-slice protocol constants
from train import load_config  # noqa: E402   and frozen-file loaders live in
from train_sft import load_frozen_parquet  # noqa: E402  scripts/, next to the
from train_target import EVAL_STOP_ROWS  # noqa: E402   gates that define them)
