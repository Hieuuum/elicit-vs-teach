...
| evt-p3-warm-sum-lr1e-3 | practical Phase-3 warm-start candidate, `sum` rows 261+492, LR 1e-3 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-sum-lr1e-2 | practical Phase-3 warm-start candidate, `sum` rows 261+492, LR 1e-2 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-sum-lr1e-1 | practical Phase-3 warm-start candidate, `sum` rows 261+492, LR 1e-1 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-sum-lr1e0 | practical Phase-3 warm-start candidate, `sum` rows 261+492, LR 1e0 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-sum-target | selected-sum residual EDL target, fixed first 100K once | planned | none — config only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-colon-lr1e-3 | practical Phase-3 warm-start candidate, broad `:` row 27 control, LR 1e-3 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-colon-lr1e-2 | practical Phase-3 warm-start candidate, broad `:` row 27 control, LR 1e-2 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-colon-lr1e-1 | practical Phase-3 warm-start candidate, broad `:` row 27 control, LR 1e-1 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-colon-lr1e0 | practical Phase-3 warm-start candidate, broad `:` row 27 control, LR 1e0 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-colon-target | selected-colon residual EDL target, fixed first 100K once | planned | none — config only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-sum-colon-lr1e-3 | practical Phase-3 warm-start candidate, `sum` + `:` rows, LR 1e-3 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-sum-colon-lr1e-2 | practical Phase-3 warm-start candidate, `sum` + `:` rows, LR 1e-2 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-sum-colon-lr1e-1 | practical Phase-3 warm-start candidate, `sum` + `:` rows, LR 1e-1 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-sum-colon-lr1e0 | practical Phase-3 warm-start candidate, `sum` + `:` rows, LR 1e0 | planned | none — config + local dataset only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
| evt-p3-warm-sum-colon-target | selected-sum-colon residual EDL target, fixed first 100K once | planned | none — config only | decisions.md 2026-07-28 "practical Phase-3 embedding warm-start" |
